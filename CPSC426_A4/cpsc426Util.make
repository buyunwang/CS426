...
ifeq ($(config),debug32)
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -Llib -L. -dynamiclib -m32 -L/usr/lib32 -stdlib=libc++ -Wl,-rpath,/Users/buyunwang/Desktop/CPSC426_A4/lib -framework OpenGL -framework Cocoa -framework IOKit -framework CoreVideo -install_name @rpath/libcpsc426Util.dylib
  LDDEPS    +=
...
ifeq ($(config),debug64)
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -Llib -L. -dynamiclib -m64 -L/usr/lib64 -stdlib=libc++ -Wl,-rpath,/Users/buyunwang/Desktop/CPSC426_A4/lib -framework OpenGL -framework Cocoa -framework IOKit -framework CoreVideo -install_name @rpath/libcpsc426Util.dylib
  LDDEPS    +=
  LIBS      += $(LDDEPS) -framework OpenGL -ldl -lpthread
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
